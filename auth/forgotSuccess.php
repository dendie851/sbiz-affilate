        ...
        <div class="authentication-inner py-12">
            ...
            <div class="card">
                <div class="p-6 p-sm-12">
                    ...
                    <h5 class="text-center text-muted font-weight-normal mb-4" style="margin-top: -30px; color: black">Reset Password</h5>

                    <div class="alert alert-dark-success alert-dismissible fade show" style="text-align: justify; padding: 20px">
                        Proses reset password anda telah berhasil di kirim ke email Anda <?php echo $email ?>                         
                    </div>
                ...
                <div class="card-footer py-3 px-4 px-sm-5">
                    <div class="text-center text-muted">
                        Kembali ke 
                        <a href="<?php echo $globalUrl ?>">Home</a>
                    </div>
                </div>
            </div>
