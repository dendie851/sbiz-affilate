                        ...
                        <tbody>
                            ...
                            <?php while($val = $dataDetail->fetch_array()): ?>
                                <tr style="cursor: pointer;">
                                    ...
                                    <td><?php echo $val['sales_order_number'] ?></td>
                                    <td><?php echo $val['name'] ?></td>
                                    <td align="center"><?php echo $val['date_order'] ?></td>
                                    <td align="right"><?php echo number_format($val['amount_fee_affiliate'], 0, ',', '.') ?></td>
                                    <td align="center"><i  class="fa fa-eye" style="font-size: 17px" onclick="showPrintModal('<?php echo $globalUrl ?>commission/print?salesOrderId=<?php echo $val['sales_order_id'] ?>')"></td>
                                </tr>
