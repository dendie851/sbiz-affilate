                    ...
                    <table  id="datatables" class="table table-striped table-bordered" data-toolbar="#bootstrap-table-toolbar" data-search="true" data-show-columns="true" data-show-export="true" data-detail-view="false" data-minimum-count-columns="3"
                        ...
                        <thead>
                            <tr>
                                ...
                                <!-- Kolom DETAIL dihapus agar seimbang dengan tbody yang hanya punya 5 kolom -->
                            </tr>                                               
                        </thead>
                        <tbody>
                            <?php $i = 1 ?>
                            ...
                            <?php while($val = $dataDetail->fetch_array()): ?>
                                <tr style="cursor: pointer;">
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" onclick="showPrintModal('<?php echo $globalUrl ?>commission/print?salesOrderId=<?php echo $val['sales_order_id'] ?>')">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatables').DataTable({
            "paging": false,
            "searching": false,
            "scrollX": true // Memastikan tabel bisa digeser kiri-kanan di HP
        });
    });  
